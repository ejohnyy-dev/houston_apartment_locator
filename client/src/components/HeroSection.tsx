      ...
      <div className="relative z-10 container py-32">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a href="#search-portal" className="inline-flex items-center justify-center px-7 py-3 bg-gold text-dark font-semibold text-sm rounded hover:opacity-90 transition-opacity">
              Open Search Portal
            </a>
