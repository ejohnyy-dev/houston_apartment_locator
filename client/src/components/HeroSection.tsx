      ...
      <div className="relative z-10 container py-32">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a href="#contact" className="inline-flex items-center justify-center px-7 py-3 border border-gold text-gold font-semibold text-sm rounded hover:bg-gold/10 transition-colors">
              Get Help
            </a>
